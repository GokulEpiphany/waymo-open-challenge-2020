...
parser.add_argument('split', choices=['validation'])
...
annotation_temp_file = os.path.join(annotation_path,'valid_small.json')
...
for seg_id in range(0,num_segs):
    ...
    if seg_id == 0:
        ...
        with open(annotation_temp_file,"w") as jsonfile:
